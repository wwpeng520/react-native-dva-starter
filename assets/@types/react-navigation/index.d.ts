...
export interface NavigationPopToPopActionPayload {
  n: number;
  immediate?: any;
}

export interface NavigationPopToPopAction extends NavigationPopToPopActionPayload {
...
export interface NavigationReplaceActionPayload {
  ...
  routeName: string;
  params?: NavigationParams;
  action?: NavigationReplaceAction;
  immediate?: any;
}
...
export namespace NavigationActions {
  ...
  function popToPop(options: NavigationPopToPopActionPayload): NavigationPopToPopAction;
  ...
  function completeTransition(options: NavigationCompleteTransitionActionPayload): NavigationCompleteTransitionAction;
}
